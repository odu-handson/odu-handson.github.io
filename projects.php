...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
				...
				<div ng-repeat="x in names">	
					<div class="col-sm-6">
						<div class="portfolio-item">
							<a ng-href="projectdesc.php?id={{x.id}}" >
							<div class="portfolio-image">
								<img src="data:image/jpg;base64,{{x.pic}}" alt="Project Name" >
							</div>
							<div class="portfolio-info">
								<ul>
									<li class="portfolio-project-name">{{x.name}}</li>
									<li>{{x.ptype}}</li>
									<li>Client: {{x.client}}</li>
									<li class="read-more"><a ng-href="projectdesc.php?id={{x.id}}" class="btn">Read more</a></li>
								</ul>
							</div>
						</div>
					</div>
		...
		$http.get("http://www.cs.odu.edu/~sthirive/handson/projectsql.php")
