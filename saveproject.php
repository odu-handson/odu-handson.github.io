...
$tused = addslashes($_POST['tused']);
$funds = addslashes($_POST['funds']);
...
if(!get_magic_quotes_gpc())
{
	...
	$sql = "insert into project (pname,abstract,client,ptype,tused,funds,team,publication,picture) values ('$pname','$abstract','$client','$ptype','$tused','$funds','$team','$publications','$content')";
//echo $sql; 
$res = mysql_query($sql,$conn);

if ($res) {
    echo "<h2>New project added successfully.</h2>";
} else {
