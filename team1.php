...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
		...
		function workingCheck(){
			...
			if(document.getElementById('details1').checked)
    ...
    <body>
        ...
        <!-- Page Title -->
		 <div ng-app="handson" ng-controller="teamCtrl" id="details" name="details">
        ...
        <div class="section">
	    	<div class="container">
				<div class="row">
					...
					<!-- Team Member -->
							<div ng-repeat="y in [1,2,3]">	
					<div ng-repeat="x in names"	

								
					<div class="col-md-4 col-sm-6" ng-click="details()">
						<a href="teammember.php">
						<div class="team-member" ng-model="name.fname"   value= "yes">
							<div class="team-member-image"><img src="data:image/jpeg;base64,{{x.pic}}" alt="Name Surname" width="200px" height="250px"></div>
							<div class="team-member-info" >
								<ul>
									<li class="team-member-name" ng-model="name.fname">{{x.name}}  <!--<label ng-model="name.lname" ng-click="details();" onclick="details1();" value= "yes">  {{x.lname}}</label> -->
        ...
        <!-- Page Title -->
		<!--<div ng-app="handson1" ng-controller="teamCtrl1" id="details1" name="details1">
		<div ng-repeat="x in names1">
		<div class="section section-breadcrumbs">
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
        ...
        <div ng-app="handson" ng-controller="teamCtrl">
        <div class="section">
	    	<div class="container">
				<div class="row"> -->
					<!-- Image Column -->
		...
		$http.get("http://www.cs.odu.edu/~sthirive/handson/teamsql.php")
		.success(function (response) {$scope.names = response.records
		},$scope.details = function () {
    $http.post("http://www.cs.odu.edu/~sthirive/handson/teamdetailsql.php", {fname:$scope.name}).success(
      function(data){
        $scope.response = data
      })
  });
	    				...
	    				<table class="jobs-list">
	    					...
	    					<tr>
	    						...
	    						<td class="job-position">
	    							<a href="page-job-details.php">Front End Developer</a> <span class="label label-danger">New</span>
	    						</td>
	    						<!-- Location -->
	    					...
	    					<tr>
	    						<td class="job-position">
	    							<a href="page-job-details.php">Back-end Developer</a> <span class="label label-danger">New</span>
	    						</td>
	    						<td class="job-location">
	    							<div class="job-country">United Kingdom</div>
	    					...
	    					<tr>
	    						<td class="job-position">
	    							<a href="page-job-details.php">Creative Director</a>
	    						</td>
	    						<td class="job-location">
	    							<div class="job-country">United Kingdom</div>
	    							<div class="job-city">Manchester</div>
	    					...
	    					<tr>
	    						<td class="job-position">
	    							<a href="page-job-details.php">Interactive Developer</a> <span class="label label-danger">New</span>
	    						</td>
	    						<td class="job-location">
	    							<div class="job-country">United Kingdom</div>
	    							<div class="job-city">Manchester</div>
	    					...
	    					<tr>
	    						<td class="job-position">
	    							<a href="page-job-details.php">Lead Designer</a>
	    						</td>
	    						<td class="job-location">
	    							<div class="job-country">United Kingdom</div>
	    							<div class="job-city">Manchester</div>
	    					...
	    					<tr>
	    						<td class="job-position">
	    							<a href="page-job-details.php">Ruby on Rails Developer</a>
	    						</td>
	    						<td class="job-location">
	    							<div class="job-country">United Kingdom</div>
	    							<div class="job-city">Manchester</div>
