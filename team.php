	    	...
	    	<div class="container">
				<div class="row">
					...
					<div class="col-md-4 col-sm-6" >
						<a ng-href="teammember.php?id={{x.id}}">
						<div class="team-member">
							<div class="team-member-image"><img src="data:image/jpeg;base64,{{x.pic}}" alt="Name Surname" height="250px"></div>
							<div class="team-member-info">
								<ul>
									<li class="team-member-name" align="center">
										{{x.name + " " + x.lname}}
