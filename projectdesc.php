...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<div class="portfolio-item">
							<div class="portfolio-image">
								<a href="#"><img src="data:image/jpg;base64,{{x.pic}}" alt="Project Name"></a>
							</div>
						</div>
					</div>
					<!-- End Image Column -->
					...
					<div class="portfolio-item-description col-sm-6">
						...
						<ul class="no-list-style">
							<li><b>Client:</b> {{x.client}}</li>
							<li><b>Project Type:</b> {{x.ptype}}</li>
							<li><b>Technologies:</b> {{x.tused}}</li>
							<li><b>Funds:</b> {{x.funds}}</li>
							<li><b>Team:</b> {{x.team}}</li>
							<li><b>Publication:</b> {{x.publication}}</li>
		...
		$http.get("http://www.cs.odu.edu/~sthirive/handson/projectdetailsql.php?id=<?php echo $_REQUEST['id'];?>")
		.success(function (response) {$scope.names = response.records1;});
		});
